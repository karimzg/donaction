...
import NewHpTimeline from './index';
...
describe('NewHpTimeline', () => {
  it('renders section title', () => {
    render(<NewHpTimeline />);
  ...
  it('renders SVG icons with aria-hidden', () => {
    const { container } = render(<NewHpTimeline />);
  ...
  it('applies CSS variable for step index', () => {
    const { container } = render(<NewHpTimeline />);
    const steps = container.querySelectorAll('.new-hp-timeline__step');
