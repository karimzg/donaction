...
export default function HpWidgetDemo() {
  return (
    <section className="hp-widget-demo w-full py-16 md:py-20 lg:py-24">
      <div className="max-w-[1320px] mx-auto px-6">
        <ScrollAnimator className="hp-widget-demo__wrapper">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-12 lg:gap-16">
            {/* Text Content - Left side */}
            <div className="hp-widget-demo__content md:w-[45%] text-center md:text-left">
          ...
          <div className="hp-widget-demo__widget-container md:w-[50%] w-full max-w-[500px]">
            <DemoWidget />
          </div>
          </div>
        </ScrollAnimator>
