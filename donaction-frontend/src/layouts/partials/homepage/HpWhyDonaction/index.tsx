...
export default function HpWhyDonaction() {
  return (
    <section className="hp-why-donaction w-full py-16 md:py-20 lg:py-24">
      <div className="max-w-[1320px] mx-auto px-6">
        <ScrollAnimator className="hp-why-donaction__wrapper">
          <h2 className="hp-why-donaction__title text-2xl md:text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-12 md:mb-16">
            Pourquoi choisir DONACTION ?
          </h2>
          <ul
            className="hp-why-donaction__grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8"
            role="list"
          ...
          >
            {ADVANTAGES.map((advantage, index) => (
              <li
                key={advantage.id}
                className="hp-why-donaction__card"
                style={{ '--card-index': index } as CardStyle}
              >
                <div className="hp-why-donaction__card-content flex flex-col items-center text-center gap-4">
                  <div className="hp-why-donaction__icon-wrapper">
                    <advantage.Icon className="hp-why-donaction__icon text-gray-700" />
                  </div>
