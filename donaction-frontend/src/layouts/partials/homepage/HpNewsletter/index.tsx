...
export default function HpNewsletter() {
	...
	return (
		<section className="hp-newsletter w-full py-16 md:py-20 lg:py-24">
			<div className="max-w-[1320px] mx-auto px-6">
				<ScrollAnimator className="hp-newsletter__wrapper">
					<div className="hp-newsletter__content text-center max-w-2xl mx-auto">
						<div className="hp-newsletter__icon" aria-hidden="true">
						...
						<h2 className="hp-newsletter__title text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
							Restez informé
						</h2>

						<p className="hp-newsletter__subtitle text-gray-500 text-base md:text-lg mb-10 leading-relaxed">
						...
						{successMessage ? (
							<div className="hp-newsletter__success">
								<svg className="hp-newsletter__success-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
							...
							<form
								className="hp-newsletter__form"
								onSubmit={handleSubmit}
								noValidate
							>
								<div className="hp-newsletter__input-group">
									...
									<button
										type="submit"
										className="hp-newsletter__button"
										disabled={isLoading}
									>
										{isLoading ? (
											<span className="hp-newsletter__spinner" aria-hidden="true" />
										) : (
											"S'abonner"
										)}
									</button>
								</div>
								<p className="hp-newsletter__disclaimer text-gray-400 text-xs mt-4">
