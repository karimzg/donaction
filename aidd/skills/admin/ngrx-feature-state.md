---
name: skill:creating-ngrx-state
description: Generates complete NgRx feature state with actions, reducer, effects, selectors, and facade pattern. Use when adding state management to donaction-admin features.
