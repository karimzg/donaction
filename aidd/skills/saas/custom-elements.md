---
name: skill:creating-web-components
description: Creates embeddable Svelte web components with custom elements for third-party sites. Use when building widgets in donaction-saas.
