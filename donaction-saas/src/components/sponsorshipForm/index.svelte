...
<script async lang="ts">
  ...
  console.log(
    'INIT',
    import.meta.env.VITE_ACTIVATE_ANALYTICS,
...
{#if SCRIPT_LOADED === 'loaded'}
  ...
  >
    ...
    <div
      ...
      style="--don-brand-primary: {SUBSCRIPTION.klubr?.klubr_house?.primary_color ||
        '#3bacf7'}; --don-brand-secondary: {SUBSCRIPTION.klubr?.klubr_house?.secondary_color ||
        '#050505'};"
    >
      {#if !$isCguShown}
