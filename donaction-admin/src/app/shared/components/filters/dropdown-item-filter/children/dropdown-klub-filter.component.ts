...
@Component({
  selector: 'app-dropdown-klubr-filter',
  imports: [
    CommonModule,
    ButtonModule,
    ReactiveFormsModule,
...
export class DropdownKlubFilterComponent extends DropdownItemFilterComponent<Klubr> implements OnInit {

  override placeholder: InputSignal<string> = input<string>('Tous les klubs');
